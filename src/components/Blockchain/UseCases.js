...
export default function UseCases(){
    return(
        <div className={styles.section1}>
            ...
            <div className="row row-cols-1 row-cols-md-3 g-4" style={{marginInline:"60px"}}>
  <div className="col">
    <div className="card h-100" style={{width:"400px"}}>
      <img src="/Blockchain/finance.jpg" style={{height:"250px"}} className="card-img-top" alt="..."/>
  ...
  <div className="col">
  <div className="card h-100" style={{width:"400px"}}>
      <img src="/Blockchain/supplychain1.jpg" style={{height:"250px"}} className="card-img-top" alt="..."/>
      <div className="card-body">
  ...
  <div className="col">
  <div className="card h-100" style={{width:"400px"}}>
      <img src="/Blockchain/identity.jpg" style={{height:"250px"}} className="card-img-top" alt="..."/>
      <div className="card-body">
  ...
  <div className="col">
  <div className="card h-100" style={{width:"400px"}}>
      <img src="/Blockchain/rights.jpg" style={{height:"250px"}} className="card-img-top" alt="..."/>
      <div className="card-body">
  ...
  <div className="col">
  <div className="card h-100" style={{width:"400px"}}>
      <img src="/Blockchain/game.jpg" style={{height:"250px"}} className="card-img-top" alt="..."/>
      <div className="card-body">
  ...
  <div className="col">
  <div className="card h-100" style={{width:"400px"}}>
      <img src="/Blockchain/realEstate.jpg" style={{height:"250px"}} className="card-img-top" alt="..."/>
      <div className="card-body">
  ...
  <div className="col">
  <div className="card h-100" style={{width:"400px"}}>
      <img src="/Blockchain/health.jpg" style={{height:"250px"}} className="card-img-top" alt="..."/>
      <div className="card-body">
  ...
  <div className="col">
  <div className="card h-100" style={{width:"400px"}}>
      <img src="/Blockchain/education.jpg" style={{height:"250px"}} className="card-img-top" alt="..."/>
      <div className="card-body">
  ...
  <div className="col">
  <div className="card h-100" style={{width:"400px"}}>
      <img src="/Blockchain/media.png" style={{height:"250px"}} className="card-img-top" alt="..."/>
      <div className="card-body">
      <h5 className="card-title" style={{fontWeight:"600"}}>Media and Entertainment</h5>
        <p className="card-text">Blockchain technology has potential use cases in media and entertainment such as creating transparent royalty payment systems, enabling secure distribution of digital content, and combating piracy through digital rights management.</p>
      </div>
    </div>
  </div>
</div>
